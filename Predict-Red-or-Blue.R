...
logit1=glm(Affiliation ~ coal+wind+solar+bio+hydro+petrol+nuclear+wood+ng+other,family=binomial(link='logit'),data=m6);logit1
...
drop1(logit1,test = 'Rao') #bio petrol
anova(logit1,test='Rao') #bio coal

#update model 1
logit2=glm(Affiliation ~ coal+bio+ng+petrol,family=binomial(link='logit'),data = m6)
